...
const SongListContainer = styled.div`
  ...
  margin: -10px; /* Add negative margin to create space between cards */
`;

const SongCard = styled.div`
  flex-basis: calc(25% - 20px); /* Set flex-basis to create four cards in one row */
